...
EPOCHS = 2                 # Recommended: 1-3 on CPU
BATCH_SIZE = 8             # Recommended: 4, 8, or 16 on CPU
LR = 2e-5                  # Standard for RoBERTa: 1e-5 ~ 3e-5
WEIGHT_DECAY = 0.01
...
def main():
    ...
    device = torch.device("cpu")  # Your instance is running on CPU
